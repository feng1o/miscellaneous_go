...
//1.简单介绍，https://leileiluoluo.com/posts/golang-context.html
//2.https://studygolang.com/articles/13866?fr=sidebar
...
func main() {
    ...
    go func() {
        fmt.Println("go to sleep randone ---------------------x---------------")
        sleepRandom("Main", nil)
        cancelFunction()
        fmt.Println("---------xbbb------------Main Sleep complete. canceling context")
    }()
    //Do work
